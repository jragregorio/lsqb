...
create table if not exists public.quotes (
  ...
  delivery_is_free boolean not null default false,
  install_steam_amount numeric(12, 2) not null default 0 check (install_steam_amount >= 0),
  install_steam_is_free boolean not null default false,
  installation_amount numeric(12, 2) not null default 0 check (installation_amount >= 0),
  installation_is_free boolean not null default false,
  steam_amount numeric(12, 2) not null default 0 check (steam_amount >= 0),
  steam_is_free boolean not null default false,
